...
export default function TitleArticles() {
    return (
        <Head>
            ...
            <title>Articles by Hussein Bouik</title>
            <meta name="description" content="Explore articles authored by Hussein Bouik, a Full Stack Engineer and Developer." />

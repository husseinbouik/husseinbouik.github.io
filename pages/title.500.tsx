...
export default function Title500() {
    return (
        <Head>
            ...
            <title>500: internal server error | Hussein Bouik</title>
            ...
            <meta name="keywords" content="500, internal server error, Hussein Bouik, Portfolio,broken link ,missing page,link not found" />

...
export default function Title404() {
    return (
        <Head>
            ...
            <title>404 - Page Not Found | Hussein Bouik</title>
            ...
            <meta name="keywords" content="404, Page Not Found, Hussein Bouik, Portfolio,broken link ,missing page,link not found" />
